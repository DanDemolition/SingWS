...
class KaraFunProviderTests(unittest.TestCase):
    ...
    def test_assisted_workflow_manages_the_macos_show_screen(self):
        ...
        self.assertIn("_enter_and_verify_fullscreen", source)
        self.assertIn("Dual Renderer still windowed; retrying fullscreen request", source)
        ...
        self.assertIn("QTimer.singleShot(400, _enter_and_verify_fullscreen)", source)
        ...
        self.assertIn("No renderer exists, so click the toggle once", handoff)
        self.assertIn("Renderer creation can still take 6-10 seconds", handoff)
    ...
    def test_karafun_monitor_requires_idle_and_end_evidence(self):
        ...
        self.assertIn("idle_stop_count >= 1 and age > 8.0", monitor)
