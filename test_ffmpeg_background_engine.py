"""Tests for the FFmpeg/Qt background-music recovery engine.
...
from ffmpeg_background_engine import (
    CHANNELS,
    FfmpegBackgroundEngine,
    SAMPLE_RATE,
)
...
class FfmpegBackgroundEngineTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def _engine(self):
        engine = FfmpegBackgroundEngine(create_sink=False)
    ...
    def test_module_has_no_gstreamer_imports(self):
        import ffmpeg_background_engine as module
